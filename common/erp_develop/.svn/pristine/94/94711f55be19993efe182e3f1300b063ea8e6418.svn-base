...
//        $pid = input("pid");
        $choose_company_id = input("choose_company_id") ? : session('user')['company_id'];
//        $status = input("status");
        $user_id = session('user')['user_id'];
        $website_uuid = session('website_uuid');
//        $data = [
...
//        ];
        ...
        $param['choose_company_id'] = $choose_company_id;
        $param['website_uuid'] = $website_uuid;
        return $this->callSoaErp('post','/ota_article/addOtaArticleType',$param);
    ...
    public function showArticleTypeEdit(){
        ...
        $type_result['data']['image'] = $type_result['data']['image'] ? : 1;
...
//        ];
        ...
        $param['user_id'] = $user_id;
        $param['choose_company_id'] = $choose_company_id;
        return $this->callSoaErp('post','/ota_article/updateOtaArticleType',$param);
