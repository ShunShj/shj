...
class Han extends Base
{
    ...
    public function han_add()
    {
        ...
        $data = [
            'team_product_name' => '泰国马杀鸡5日游',
            'route_template_id'=> 2,
            'route_type_id' => 2,
            'use_company_id' => 1,
            'settlement_type' => 2,
            'team_product_user_id' => 1,
            'plan_custom_number' => 100,
            'before_days' => 90,
            'begin_time'=> 15350912,
            'team_product_flight_info' => [
                [
                    'the_days' => 1,
                    'start_city' => '上海1',
                    'end_city' => '泰国1',
            ...
            'team_product_once_price' => [
                [
                    'company_id' => 1,
                    'total_price' => 12000
                ]
            ],
            'team_product_return_receipt' => [
              [
                  'title' => '好啊1',
                  'content' => '321',
                  'sorting' => 1
        ...
        $result =  $this->callSoaErp('post','/product/addTeamProduct',$data);
