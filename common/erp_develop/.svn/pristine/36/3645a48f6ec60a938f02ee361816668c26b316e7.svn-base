...
//    });
    ...
    $(':checkbox:checked').each(function(i){
        ...
        tourPax += "<li id="+i+">";
        tourPax += paxInfo[i] + "|" + ageInfo[i]+'|'+temp_id[i];
        tourPax += "</li>";
        if(ageInfo[i] == 'Adult')
        {
            adult++;
    ...
    else
    {
        ...
        temp_id_obj[$a] = temp_id;
        console.log(temp_id_obj);
        console.log('____111______');
        ...
        .dialog({
            ...
            buttons: {
                Yes: function () {
                    $("#room_pax").empty();
                    $(this).dialog("close");
                    $.get('/book_tour/kill_roomconfig_session');
