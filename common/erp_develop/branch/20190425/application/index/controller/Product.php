...
//        return $this->fetch('plan_booking_passenger');
        ...
        $this->assign('room_type',[1=>'双人床',2=>'大床',3=>'单人床',4=>'加床']);
...
//        var_dump($setPlanTourManage);exit;
        ...
        if(is_numeric($setPlanTourManage['search_plur_status'])){ //团队状态
            $where['plur_status'] = $setPlanTourManage['search_plur_status'];
        }else{
            $setPlanTourManage['search_plur_status']='-1';
        }
...
//        echo '<pre>';print_r($TeamProductList);exit;
        ...
        $this->assign('team_statu',['0'=>'未成团','1'=>'成团','2'=>'结算','3'=>'结团']);
...
//            var_dump($customer_data);exit;
    ...
    public function upPlurStatusAjax(){
        ...
        $this->callSoaErp('post','/product/upPlurStatusAjax',$d);
        return $d['plur_status'];
    }
    ...
    */
    public function tourStatistics(){
        ...
        $NumberOfPassengersOnALine_companyId_routeTypeId = Arrays::group($NumberOfPassengersOnALine,function($ar){ //分公司||
