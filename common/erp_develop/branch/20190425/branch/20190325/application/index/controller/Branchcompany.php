...
//            'status'=>1,
    ...
    public function addBranchProductAjax()
    {
        ...
        $branch_product_end_time = strtotime(input("branch_product_end_time"));
        $remark = input("remark");
        $status = input('status');
...
//        echo "<pre>";
//        var_dump($branch_source_result);exit;
//        echo "</pre>";
    ...
    {
        $setCustomerManage = Session::get('setCustomerManage');
        if (!empty($setCustomerManage['search_Number'])) {
            $data['customer_number'] = $setCustomerManage['search_Number'];
        }
//        if (!empty($setCustomerManage['search_Name'])) {
//            $data['customer_name'] = $setCustomerManage['search_Name'];
//        }
        if (!empty($setCustomerManage['search_phone'])) {
            $data['phone'] = $setCustomerManage['search_phone'];
        }
        $data['company_id'] = session('user')['company_id'];
        $data['page']=$this->page();
        ...
        $this->assign('setCustomerManage', $setCustomerManage);
    ...
    public function AddCustomerAjax()
    {
        ...
        return $this->callSoaErp('post', '/branchcompany/addCustomer', $data);
    }
    ...
    public function showCustomerEdit()
    {
        ...
        $data['level'] = 1;
        $CountryData = $this->callSoaErp('post', '/system/getCountry', $data);
        $this->assign('CountryData',$CountryData['data']);
    ...
    */
    public function getDistributorTemplateAjax(){
		...
		if(!empty(input('company_order_create_to_time'))){
			$data['company_order_create_to_time'] = strtotime('+1 days',input('company_order_create_to_time'));
		}
		...
		if(!empty(input('company_order_end_time'))){
			$data['company_order_end_time'] = strtotime('+1 days',input('company_order_end_time'));
		}
