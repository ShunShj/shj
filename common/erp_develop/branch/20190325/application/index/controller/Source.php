...
//        $result1 = $this->callSoaErp('post', '/system_alert_event/addInStationLetterAndEmail',$data1);
    ...
    public function showAgentManage(){
        ...
        $data = $this->callSoaErp('post','/source/getSupplier',$data);
...
//            "single_settlement_price"=>$single_settlement_price,
    ...
    public function showAgentSource(){
        ...
        $hotel_result = $this->callSoaErp('post', '/source/getHotel',$data_hotel);
        ...
        $dining_result = $this->callSoaErp('post', '/source/getDining',$data_dining);
        ...
        $flight_result = $this->callSoaErp('post', '/source/getFlight',$data_flight);
        ...
        $cruise_result = $this->callSoaErp('post', '/source/getCruise',$data_cruise);
        ...
        $visa_result = $this->callSoaErp('post', '/source/getVisa',$data_visa);
        ...
        $scenic_spot_result = $this->callSoaErp('post', '/source/getScenicSpot',$data_scenic_spot);
        ...
        $vehicle_result = $this->callSoaErp('post', '/source/getVehicle',$data_vehicle);
        ...
        $tour_guide_result = $this->callSoaErp('post', '/source/getTourGuide',$data_tour_guide);
        ...
        $single_source_result = $this->callSoaErp('post', '/source/getSingleSource',$data_single_source);
        ...
        $own_expense_result = $this->callSoaErp('post', '/source/getOwnExpense',$data_own_expense);
...
//        $this->assign('CruisesAr',$CruisesAr);
    ...
    public function showCruisesSourceEdit(){
        ...
        //邮轮供应商
        $CruisesAr = $this->getSupplierBySupplierTypeId(5);
        $supplierList = $CruisesAr;//array_merge($agentAr,$CruisesAr);
...
//        $this->assign('agentAr',$agentAr);
        ...
        $this->assign('VisaSourceAr',$VisaSourceAr['data']);
...
//        $this->assign('VisaSourceAr',$VisaSourceAr);
    ...
    public function showVisaSourceEdit(){
        ...
        //签证供应商
        $VisaSourceAr = $this->getSupplierBySupplierTypeId(6);
        $SupplierAr = $VisaSourceAr;//array_merge($agentAr,$VisaSourceAr);
...
//        $this->assign('agentAr',$agentAr);
        ...
        $this->assign('ScenicSpotSupplierAr',$ScenicSpotSupplierAr['data']);
...
//        $this->assign('agentAr',$agentAr);
        ...
        $this->assign('VehicleSupplierAr',$VehicleSupplierAr['data']);
...
//        $this->assign('agentAr',$agentAr);
        ...
        $this->assign('guideSupplierAr',$guideSupplierAr['data']);
