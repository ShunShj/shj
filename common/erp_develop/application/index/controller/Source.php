...
//        $this->assign('supplier_data_result',$this->types);
		...
		*/
        ...
        {
            $supplier_account = $this->callSoaErp('post','/source/getSupplierAccount',['supplier_id' => $v['supplier_id'], 'object_company_id' => session('user')['company_id']]);
            $result['data']['list'][$k]['account'] = $supplier_account['data']['supplier_account']['account'];
            $result['data']['list'][$k]['symbol'] = $supplier_account['data']['supplier_account']['symbol'];
        }
    ...
    public function addSupplierAjax(){
        ...
        $choose_company_id = input('choose_company_id');
        $supplier_style = input("supplier_style");
...
//        setcookie('hotel_manage','',time()-3600);
//        setcookie("hotel_manage",$_SERVER['REQUEST_URI'],time()+3600);
...
//        $this->assign('data',$result['data']);
    ...
    public function showCompanyHotelSource(){
        $params = [
            'company_id' => session('user')['company_id'],
            'company_name' => session('user')['company_name'],
        ];
        ...
        return $this->fetch('company_hotel_source');
    }

    public function showCompanyDiningSource(){
        $params = [
            'company_id' => session('user')['company_id'],
            'company_name' => session('user')['company_name'],
        ];
        ...
        $this->getPageParams($dining_result);
        //$this->assign('dining_result',$dining_result['data']);

        return $this->fetch('company_dining_source');
    }

    public function showCompanyFlightSource(){
        $params = [
            'company_id' => session('user')['company_id'],
            'company_name' => session('user')['company_name'],
        ];
        ...
        $flight_result = $this->callSoaErp('post', '/source/getFlight',$data);
        $this->getPageParams($flight_result);

        return $this->fetch('company_flight_source');
    }

    public function showCompanyCruiseSource(){
        $params = [
            'company_id' => session('user')['company_id'],
            'company_name' => session('user')['company_name'],
        ];
        ...
        $cruise_result = $this->callSoaErp('post', '/source/getCruise',$data);
        $this->getPageParams($cruise_result);

        return $this->fetch('company_cruise_source');
    }

    public function showCompanyVisaSource(){
        $params = [
            'company_id' => session('user')['company_id'],
            'company_name' => session('user')['company_name'],
        ];
        ...
        $visa_result = $this->callSoaErp('post', '/source/getVisa',$data);
        $this->getPageParams($visa_result);

        return $this->fetch('company_visa_source');
    }

    public function showCompanyScenicSpotSource(){
        $params = [
            'company_id' => session('user')['company_id'],
            'company_name' => session('user')['company_name'],
        ];
        ...
        $scenic_spot_result = $this->callSoaErp('post', '/source/getScenicSpot',$data);
        $this->getPageParams($scenic_spot_result);

        return $this->fetch('company_scenic_spot_source');
    }

    public function showCompanyVehicleSource(){
        $params = [
            'company_id' => session('user')['company_id'],
            'company_name' => session('user')['company_name'],
        ];
        ...
        $vehicle_result = $this->callSoaErp('post', '/source/getVehicle',$data);
        $this->getPageParams($vehicle_result);

        return $this->fetch('company_vehicle_source');
    }

    public function showCompanyTourGuideSource(){
        $params = [
            'company_id' => session('user')['company_id'],
            'company_name' => session('user')['company_name'],
        ];
        ...
        $tour_guide_result = $this->callSoaErp('post', '/source/getTourGuide',$data);
        $this->getPageParams($tour_guide_result);

        return $this->fetch('company_tour_guide_source');
    }

    public function showCompanySingleSourceSource(){
        $params = [
            'company_id' => session('user')['company_id'],
            'company_name' => session('user')['company_name'],
        ];
        ...
        $single_source_result = $this->callSoaErp('post', '/source/getSingleSource',$data);
        $this->getPageParams($single_source_result);

        return $this->fetch('company_single_source_source');
    }

    public function showCompanyOwnExpenseSource(){
        $params = [
            'company_id' => session('user')['company_id'],
            'company_name' => session('user')['company_name'],
        ];
        ...
        $own_expense_result = $this->callSoaErp('post', '/source/getOwnExpense',$data);
        $this->getPageParams($own_expense_result);

        return $this->fetch('company_own_expense_source');
    }

    public function showCompanyShoppingSource(){
        $params = [
            'company_id' => session('user')['company_id'],
            'company_name' => session('user')['company_name'],
        ];
        ...
        $shopping_result = $this->callSoaErp('post', '/source/getShopping', $data);
        $this->getPageParams($shopping_result);

        return $this->fetch('company_shopping_source');
    }
    ...
    public function supplierAccount()
    {
        ...
        $params = Request::instance()->param();
        $params['object_company_id'] = session('user')['company_id'];

        $supplier_account_result = $this->callSoaErp('post', '/source/getSupplierAccount',$params);

        $this->assign('supplier_account',$supplier_account_result['data']['supplier_account']);
        $this->assign('supplier_account_info',$supplier_account_result['data']['supplier_account_info']);

        return $this->fetch('supplier_account');
    }


    public function showAgentHotelSource(){
        $supplier_id = input('supplier_id');
        $this->assign('supplier_id',$supplier_id);
        //读取相关酒店信息 2
        $data = [
        ...
        return $this->fetch('agent_hotel_source');
    }

    public function showAgentDiningSource(){
        $supplier_id = input('supplier_id');
        $this->assign('supplier_id',$supplier_id);
        //读取相关酒店信息 2
        $data = [
        ...
        return $this->fetch('agent_dining_source');
    }

    public function showAgentFlightSource(){
        $supplier_id = input('supplier_id');
        $this->assign('supplier_id',$supplier_id);
        //读取相关酒店信息 2
        $data = [
        ...
        return $this->fetch('agent_flight_source');
    }

    public function showAgentCruiseSource(){
        $supplier_id = input('supplier_id');
        $this->assign('supplier_id',$supplier_id);
        //读取相关酒店信息 2
        $data = [
        ...
        return $this->fetch('agent_cruise_source');
    }

    public function showAgentVisaSource(){
        $supplier_id = input('supplier_id');
        $this->assign('supplier_id',$supplier_id);
        //读取相关酒店信息 2
        $data = [
        ...
        return $this->fetch('agent_visa_source');
    }

    public function showAgentScenicSpotSource(){
        $supplier_id = input('supplier_id');
        $this->assign('supplier_id',$supplier_id);
        //读取相关酒店信息 2
        $data = [
        ...
        return $this->fetch('agent_scenic_spot_source');
    }

    public function showAgentVehicleSource(){
        $supplier_id = input('supplier_id');
        $this->assign('supplier_id',$supplier_id);
        //读取相关酒店信息 2
        $data = [
        ...
        return $this->fetch('agent_vehicle_source');
    }

    public function showAgentTourGuideSource(){
        $supplier_id = input('supplier_id');
        $this->assign('supplier_id',$supplier_id);
        //读取相关酒店信息 2
        $data = [
        ...
        return $this->fetch('agent_tour_guide_source');
    }

    public function showAgentSingleSourceSource(){
        $supplier_id = input('supplier_id');
        $this->assign('supplier_id',$supplier_id);
        //读取相关酒店信息 2
        $data = [
        ...
        return $this->fetch('agent_single_source_source');
    }

    public function showAgentOwnExpenseSource(){
        $supplier_id = input('supplier_id');
        $this->assign('supplier_id',$supplier_id);
        //读取相关酒店信息 2
        $data = [
        ...
        return $this->fetch('agent_own_expense_source');
    }

    public function showAgentShoppingSource(){
        $supplier_id = input('supplier_id');
        ...
        return $this->fetch('agent_shopping_source');
    }
