...
use think\config;
use think\Db;
class RouteSourceTourGuide extends Model{
    //protected $connection = ['database' => 'erp'];
    protected $table = 'route_source_tour_guide';
     ...
     * 胡
     */
    public function addRouteSourceTourGuide($params){
    	$t = time();


    	$data['route_template_id'] = $params['route_template_id'];
    	$data['tour_guide_id'] = $params['tour_guide_id'];
    	...
    	Db::startTrans();
    	try{
    		$pk_id = Db::name('route_source_tour_guide')->insertGetId($data);
